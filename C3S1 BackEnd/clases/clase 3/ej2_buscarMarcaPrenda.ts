...
const marca1:Marca = {id:1,nombre:"AOIUDAHOIDHAOI"};
const marca2:Marca = {id:2,nombre:"LÑFKKOEF"};
const marca3:Marca = {id:3,nombre:"DAHIWOPAJDPAW"};
const marca4:Marca = {id:4,nombre:"DLOEIORE"};
...
// devolver solo las marcas que tengan la letra l

const array_marcas_con_l:Array<Marca> = arrayDeMarcas.filter((x)=>x.nombre.includes("L"));
console.log(array_marcas_con_l);