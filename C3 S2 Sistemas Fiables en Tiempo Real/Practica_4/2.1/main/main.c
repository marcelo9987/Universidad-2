...
//CONTADORES
#define ITERATE_1 55e4
#define ITERATE_2 40e4
#define ITERATE_3 30e4
#define ITERATE_4 30e4
#define ITERATE_5 30e4
...
{   
    ...
    //Crea tareas
    xTaskCreate( vTaskCode1, "TASK1", STACK_SIZE, NULL, 10, &xHandle1 );  //Prioridad 10
