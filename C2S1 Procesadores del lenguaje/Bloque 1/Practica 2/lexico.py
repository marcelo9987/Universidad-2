...
class Lexico:
    def __init__(self, programa): #constructor
        ...
        self.lineas = 1 #líneas totales del programa
    ...
    def get_componente_lexico(self):
        ...
        if self.caracter.isalpha():
            ...
            while self.caracter.isalnum():  # un identificador puede tener números, menos en la primera letra
                lexema += self.caracter
                self.caracter = self.extrae_caracter()
            self.devuelve_caracter()
        ...
        # secuencias de dígitos, número enteros o reales
